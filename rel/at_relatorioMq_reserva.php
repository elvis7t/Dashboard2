...
session_start();
$sess = "REL";
$pag = "at_relatorioMq_reserva.php";
						...
						<form role="form" id="rels">
							<div class="box-body">
								...
								<div class="row">
										...
										<input type="hidden" value="at_maquinas" name="rel_tbl_res" id="rel_tbl_res">		
						...
						<div class="box-body">
							...
							<div class="row">
							 ...
							 <div class="row no-print">
								...
								<button class="btn btn-sm btn-primary" type="button" id="bt_relMq_res"><i class="fa fa-file-pdf-o"></i> Gerar Relat&oacute;rio</button>
...
<script src="https://infraprime.000webhostapp.com/dashboard/assets/plugins/jQuery/jQuery-2.1.4.min.js"></script>
   ...
   <!-- Slimscroll -->
    ...
    <script src="https://infraprime.000webhostapp.com/dashboard/assets/plugins/input-mask/jquery.inputmask.js"></script>
    <script src="https://infraprime.000webhostapp.com/dashboard/assets/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
    <script src="https://infraprime.000webhostapp.com/dashboard/assets/plugins/input-mask/jquery.inputmask.extensions.js"></script>

    <script src="https://infraprime.000webhostapp.com/dashboard/js/action_ativos.js"></script>
    <script src="https://infraprime.000webhostapp.com/dashboard/js/jquery.cookie.js"></script>
    <script src="https://infraprime.000webhostapp.com/dashboard/js/controle.js"></script>
