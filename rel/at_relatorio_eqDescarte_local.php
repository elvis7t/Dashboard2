...
session_start();
$sess = "REL_LOCAL";
$pag = "at_relatorio_eqDescarte_local.php"; 
					...
					<div class="box box-primary">
						...
						<form role="form" id="rels">
							...
							<div class="box-footer">
								<button class="btn btn-sm btn-primary" type="button" id="bt_relEqdesc"><i class="fa fa-pie-chart"></i> Gerar Relat&oacute;rio</button>
