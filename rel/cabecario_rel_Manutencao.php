					...
					<div class="box box-primary">
						...
						<form role="form" id="rels">
							...
							<div class="box-footer">
								<button class="btn btn-sm btn-primary" type="button" id="bt_relManutencao"><i class="fa fa-pie-chart"></i> Gerar Relat&oacute;rio</button>
					...
					<div class="box box-primary">
						...
						<form role="form" id="rels">
							<div class="box-body">
								...
								<div class="row">
										...
										<input type="hidden" value="<?=$preid;?>" name="sel_pre" id="sel_pre">		
						...
						<div class="box-body">  
							<div class="row invoice-info">
								...
								$rs = new recordset();   
								$sql = "SELECT * FROM eq_prestadoras WHERE pre_id=".$preid; 
								$rs->FreeSql($sql);
								$rs->GeraDados(); 
								?>
							</div><!-- /.row --> 
