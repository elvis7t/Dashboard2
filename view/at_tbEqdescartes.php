...
while($rs->GeraDados()){ ?> 
	...
	<td>   
			<div class="button-group">  
				...
				<a 	class="btn btn-xs btn-danger" data-toggle='tooltip' data-placement='bottom' title='Detalhes'  a href="at_ver_Eqdescarte.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$rs->fld('eq_id');?>"><i class="fa fa-thumbs-down"></i></a> 
