...
?>
								...
								<!-- radio Clientes -->
									...
									<div class="col-md-4">
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_elvis;?>" alt="User Avatar">
										</div>
									...
									<div class="col-md-4">
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_anderson;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right">  
									...
									<div class="col-md-4">
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_peterson;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right"> 
									...
									<div class="col-md-4">
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_matias;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right"> 
									...
									<!-- /.col -->
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_fernando;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right"> 
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_wilson;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right"> 
									...
									<div class="row">
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_emerson;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right"> 
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_valmar;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right"> 
									...
									<div class="col-md-4">
									  ...
									  <div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
										  <img class="img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$foto_andre;?>" alt="User Avatar">
										</div>
										<div class="box-footer">
										  <div class="row">
											<div class="col-sm-4 border-right"> 
 ...
 <?php 
	...
	<script src="https://infraprime.000webhostapp.com/dashboard/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
