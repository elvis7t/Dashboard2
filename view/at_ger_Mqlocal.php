					...
					<div class="box-header with-border">
						...
						<form role="form" id="alt_mq">
							...
							<table id="maquinas" class="table table-bordered table-striped">     
								...
								<td><a 	class="btn btn-sm btn-success" data-toggle='tooltip' data-placement='bottom' title='Alterar usu&aacute;rio'  a href="at_alt_usu_Mqlocal.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="fa fa-user-plus"></i> Alterar usu&aacute;rio</a></td> 
								...
								<!--<td><a 	class="btn btn-sm btn-warning" data-toggle='tooltip' data-placement='bottom' title='solicita&ccedil;&atilde;o'  a href="at_solic_Eq.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="fa fa-bullhorn"></i> Solicita&ccedil;&atilde;o</a></td>-->
								<?php 
								if($usu_id==0):?>
								<td><a 	class="btn btn-sm btn-danger" data-toggle='tooltip' data-placement='bottom' title='Manuten&ccedil;&atilde;o'  a href="at_man_Mqlocalsemusu.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="fa fa-wrench"></i> Manuten&ccedil;&atilde;o</a></td>
								<?php else: ?>
								...
								<td><a 	class="btn btn-sm btn-danger" data-toggle='tooltip' data-placement='bottom' title='Descarte'  a href="at_descartar_Mqlocal.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="fa fa-recycle"></i> Descartar</a></td> 
								
								<td><a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='Outras ocorrencias'  a href="at_outros_Mqlocal.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="glyphicon glyphicon-question-sign"></i> Outros</a></td> 
							</tr>
							</table>
							</div>
							<div id="mens"></div> 
