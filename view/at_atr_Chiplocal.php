					...
					<div class="box-header with-border">
						...
						<form role="form" id="atr_chip"> 
							...
							<div class="box-footer"> 
								...
								<a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='Gerenciar'  a href="at_ger_Chiplocal.php?token=<?=$_SESSION['token']?>&acao=N&chipid=<?=$chip;?>"><i class="fa fa-dashboard"></i> Gerenciar </a>
