				...
				<!-- general form elements -->
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Cadastro de Prestadoras de servi&ccedil;0</h3><div class="box-tools pull-right">
						...
						<form id="cadPre" role="form">
							<div class="box-body">
								...
								<div class="form-group col-md-2">
										...
										<input type="text" class="form-control cep" id="cep" name="cep"  placeholder="Desc. o CEP"value="<?=$rs->fld("dados_cep");?>" <?=$disable; ?>>
									</div>
									</div>
