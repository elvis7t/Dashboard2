...
?>
				...
				<div class="col-md-3"> <!-- left menu-->
				  ...
				  <div class="box box-primary">
						<div class="box-body box-profile">
						  <img class="profile-user-img img-responsive img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$rs->fld('usu_foto');?>" alt="User profile picture">
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="form-group col-md-2">
										  ...
										  <input class="form-control input-sm text-uppercase" readonly id=""  value="<?=$fn->data_br($rs->fld('usu_datacad'));?>" <?=$disable; ?>> 
										</div>
	...
	<!-- jQuery Knob -->
	<script src="https://infraprime.000webhostapp.com/dashboard/assets/plugins/knob/jquery.knob.js"></script>    
    <!--AdminLTE App -->
	...
	<script src="https://infraprime.000webhostapp.com/dashboard/js/action_usuarios.js"></script>  <!--Chama o java script para mascara -->
	<script src="https://infraprime.000webhostapp.com/dashboard/js/controle.js"></script>  <!--Chama o java script para mascara e CEP AUTOMATICO -->
	<!-- Validation --> 
	<!-- SELECT2 TO FORMS --> 
