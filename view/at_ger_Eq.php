    ...
    <div class="content-wrapper">
        ...
        <section class="content">
			<?php 
				...
				$eq_tpId    	= $rs->fld("eq_tipoId");  
				$eq_serial2    	= $rs->fld("eq_serial2");  
						...
						<form role="form" id="alt_eq">
							...
							<table id="maquinas" class="table table-bordered table-striped">
								<tr> 
									...
									<td><a 	class="btn btn-sm btn-success" data-toggle='tooltip' data-placement='bottom' title='Alterar usu&aacute;rio'  a href="at_alt_usu_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="fa fa-user-plus"></i> Alterar usu&aacute;rio</a></td> 
									...
									<td><a 	class="btn btn-sm btn-warning" data-toggle='tooltip' data-placement='bottom' title='solicita&ccedil;&atilde;o'  a href="at_solic_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="fa fa-bullhorn"></i> Solicita&ccedil;&atilde;o</a></td>
									
									<td><a 	class="btn btn-sm btn-warning" data-toggle='tooltip' data-placement='bottom' title='Emprestimo'  a href="at_empre_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="glyphicon glyphicon-retweet"></i> Emprestimo</a></td>
									
									<td><a 	class="btn btn-sm btn-danger" data-toggle='tooltip' data-placement='bottom' title='Manuten&ccedil;&atilde;o'  a href="at_man_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="fa fa-wrench"></i> Manuten&ccedil;&atilde;o</a></td>
									...
									<td><a 	class="btn btn-sm btn-danger" data-toggle='tooltip' data-placement='bottom' title='solicita&ccedil;&atilde;o'  a href="at_descartar_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="fa fa-recycle"></i> Descartar</a></td> 
									<?php
													
													$whr = "eq_id=".$eqid;
													$rs->Seleciona("*","at_equipamentos a
														JOIN eq_tipo b ON a.eq_tipoId = b.tipo_id",$whr); //É o mesmo que SELECT campos FROM tabela WHERE condição
													while($rs->GeraDados()){ // enquanto gerar dados da pesquisa
									...
									<td>   
										<div class="button-group">  
											<?php 
												...
												<a 	class="btn btn-sm btn-primary" data-toggle='tooltip' data-placement='bottom' title='Cadastrar IMEI2'  a href="at_vis_imei2_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$rs->fld("eq_id");?>"><i class="fa fa fa-file-text"></i> IMEI2</a> 
												<td><a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='solicita&ccedil;&atilde;o'  a href="at_outros_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="glyphicon glyphicon-question-sign"></i> Outros</a></td>
												<?php else: ?>
