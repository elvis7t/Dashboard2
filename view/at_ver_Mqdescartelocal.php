...
session_start();
$sess = "ATIVOLOCAL";
$pag = "at_descarteslocais.php";// Fazer o link brilhar quando a pag estiver ativa
							...
							<div class="box-body">
								...
								<div class="row">
									 ...
									 <div class="form-group col-md-3">
										...
										<input type="text" DISABLED class="form-control" name="marc_nome" id="marc_nome" value="<?=$fn->data_hbr($rs->fld("mq_datacad"));?>"/>
										...
										<input type="text" DISABLED class="form-control" name="marc_nome" id="marc_nome" value="<?=$fn->data_hbr($rs->fld("mq_datades"));?>"/>
