			 ...
			 <div class="row"> 
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<div class="col-md-2"><img class="profile-user-img img-responsive img-circle" src="https://infraprime.000webhostapp.com/dashboard/<?=$rs->fld('emp_logo');?>" alt="Logo da Empresa"></div> 
							<h2><?=$rs->fld("emp_nome");?>								
