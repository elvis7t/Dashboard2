										...
										<?php
												...
												<span class="input-group-btn">
												 	<div class="button-group"> 
														<a 	class="btn btn-sm btn-info pull-left" data-toggle='tooltip' data-placement='bottom' title='Gerenciar'  a href="at_ger_Mqlocal.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$rs->fld('mq_id');?>"><i class="fa fa-dashboard"></i></a>
														<a 	class="btn btn-sm btn-primary pull-right " data-toggle='tooltip' data-placement='bottom' title='Gerar Termo'  a href="at_vis_termo_Mqlocal.php?token=<?=$_SESSION['token']?>&acao=N&usuid=<?=$usuid;?>"><i class="fa fa-file-text"></i></a>
													</div> 
												  </span>
												</div>
										<?php
				...
				<div class="box box-success ">
					...
					<div class="box-body">
						<table id="manutencao" class="table table-bordered table-striped">
							...
							<tbody id="Man_cad">  
							<?php require_once("at_tbUsuequipamentoslocais.php");?>    	
							</tbody> 
