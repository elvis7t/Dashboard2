        ...
        <section class="content">
			...
			<div class="row">
				...
				<div class="box box-success"> 
					...
					<!-- form start -->
					<div class="box-body"> 
						<table id="prest" class="table table-bordered table-striped">
							<thead>
								  <tr> 
										<th>C&oacute;d:</th>
							...
							<tbody id="Pre_cad"> 
								<?php require_once("at_tbPrestadoraslocais.php");?>   
							</tbody> 
							 
						</table> 
					</div><!-- /.box-body --> 
					<div class="box-footer">
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Nova Prestdora' href="at_vis_Prestadoraslocais.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Nova</a>
			</div>
